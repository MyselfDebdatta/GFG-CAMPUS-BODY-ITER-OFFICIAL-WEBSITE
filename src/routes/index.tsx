  ...
  return (
    <div className="relative min-h-screen bg-[#020b06] selection:bg-[#00ff7f]/30">
              ...
              <div className="grid grid-cols-2 gap-y-10 md:grid-cols-4 md:gap-y-0 relative">
                {STATS.map((s, i) => (
                  <div key={s.label} className="relative text-center group">
                    <div className="text-4xl sm:text-5xl font-extrabold tracking-tight transition-all duration-300 group-raw-hover:scale-110 text-transparent bg-clip-text bg-gradient-to-r from-white via-white to-white group-raw-hover:bg-[linear-gradient(to_right,#32CD32,#e2da24,#32CD32)]">
          ...
          <Reveal>
            ...
            <div className="mt-8 grid gap-4 sm:grid-cols-2">
              {[
                ...
                <div key={f.title} className="group rounded-xl border border-[#00ff7f]/20 bg-white/5 p-4 backdrop-blur-md transition-all duration-300 raw-hover:border-[#00ff7f] raw-hover:bg-white/10 raw-hover:shadow-[0_0_12px_rgba(0,255,127,0.4)]">
                  ...
                  <div className="mt-3 font-semibold text-transparent bg-clip-text bg-gradient-to-r from-white via-white to-white transition-all duration-300 group-raw-hover:bg-[linear-gradient(to_right,#32CD32,#e2da24,#32CD32)]">{f.title}</div>
            ...
            <div className="grid gap-6 md:grid-cols-2">
              {EVENTS.filter((e) => e.status === "upcoming").slice(0, 1).map((e, i) => (
                <Reveal key={e.id} delay={0.1}>
                  <div className="flex flex-col h-full rounded-3xl border border-[#00ff7f]/30 bg-white/5 overflow-hidden backdrop-blur-md transition-all duration-300 raw-hover:border-[#00ff7f] raw-hover:shadow-[0_0_12px_rgba(0,255,127,0.4)] relative group">
              ...
              {EVENTS.filter((e) => e.status === "ongoing").slice(0, 1).map((e, i) => (
                <Reveal key={e.id} delay={0.2}>
                  <div className="flex flex-col h-full rounded-3xl border border-[#3b82f6]/40 bg-white/5 overflow-hidden backdrop-blur-md transition-all duration-300 raw-hover:border-[#3b82f6] raw-hover:shadow-[0_0_12px_rgba(59,130,246,0.4)] relative group">
                    ...
                    <Reveal key={e.id} delay={i * 0.1}>
                      ...
                      <div onClick={undefined} className="block overflow-hidden rounded-2xl border border-white/10 bg-white/5 backdrop-blur-md transition-all duration-300 raw-hover:-translate-y-1 raw-hover:border-white/50 raw-hover:shadow-[0_0_12px_rgba(255,255,255,0.2)] sm:flex cursor-pointer">
                        ...
                        <div className="p-5 sm:w-2/3 flex flex-col justify-center">
                          ...
                          <h4 className="mt-3 text-lg font-bold transition-all duration-300 text-transparent bg-clip-text bg-gradient-to-r from-white via-white to-white group-raw-hover:bg-[linear-gradient(to_right,#32CD32,#e2da24,#32CD32)]">{e.title}</h4>
        ...
        <div className="mt-10 grid gap-6 sm:grid-cols-2 lg:grid-cols-3 max-w-5xl mx-auto">
          {TEAM.slice(0, 9).map((m, i) => (
            <Reveal key={m.name} delay={i * 0.05}>
              <div className="group relative overflow-hidden rounded-2xl border border-[#00ff7f]/20 bg-white/5 backdrop-blur-md transition-all duration-300 raw-hover:border-[#00ff7f] raw-hover:shadow-[0_0_12px_rgba(0,255,127,0.4)]">
                ...
                <div className="p-4">
                  ...
                  <div className="mt-1 font-semibold transition-all duration-300 text-transparent bg-clip-text bg-gradient-to-r from-white via-white to-white group-raw-hover:bg-[linear-gradient(to_right,#32CD32,#e2da24,#32CD32)]">{m.name}</div>
                </div>
              </div>
            </Reveal>
          ))}
      ...
      <section className="relative z-10 container-page pb-24">
        <div className="group relative overflow-hidden rounded-[2rem] border border-white/5 bg-[#060D09] p-8 md:p-10 transition-all duration-300 raw-hover:border-[#00ff7f] raw-hover:shadow-[0_0_12px_rgba(0,255,127,0.4)]">
          ...
          <div className="relative grid gap-8 lg:grid-cols-2 lg:items-center">
            <div>
              ...
              <h2 className="text-4xl sm:text-5xl md:text-6xl font-bold tracking-tight leading-[1.1] mb-4 transition-all duration-300 text-transparent bg-clip-text bg-gradient-to-r from-white via-white to-white group-raw-hover:bg-[linear-gradient(to_right,#32CD32,#e2da24,#32CD32)]">
  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col flex-1 p-6 md:p-8">
        ...
        <h3 className="mt-2 text-2xl font-bold tracking-tight text-transparent bg-clip-text bg-gradient-to-r from-white via-white to-white transition-all duration-300 group-raw-hover:bg-[linear-gradient(to_right,#32CD32,#e2da24,#32CD32)]">{event.title}</h3>
