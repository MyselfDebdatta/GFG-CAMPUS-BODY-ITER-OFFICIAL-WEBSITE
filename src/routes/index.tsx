...
function EventIcon({ category }: { category: string }) {
  ...
  if (cat.includes("community")) return <Coffee className="h-4 w-4 text-white/70 group-hover:text-[#00ff7f] group-active:text-[#00ff7f] active:text-[#00ff7f]" />;
  if (cat.includes("competition") || cat.includes("contest")) return <Award className="h-4 w-4 text-white/70 group-hover:text-[#00ff7f] group-active:text-[#00ff7f] active:text-[#00ff7f]" />;
  if (cat.includes("seminar")) return <Mic className="h-4 w-4 text-white/70 group-hover:text-[#00ff7f] group-active:text-[#00ff7f] active:text-[#00ff7f]" />;
  if (cat.includes("flagship")) return <Sparkles className="h-4 w-4 text-white/70 group-hover:text-[#00ff7f] group-active:text-[#00ff7f] active:text-[#00ff7f]" />;
  return <Users className="h-4 w-4 text-white/70 group-hover:text-[#00ff7f] group-active:text-[#00ff7f] active:text-[#00ff7f]" />;
}
    ...
    <div className="relative min-h-screen bg-[#020b06] selection:bg-[#00ff7f]/30">
        ...
        <div className="container-page relative pt-2 pb-20 md:pt-4 md:pb-32">
          ...
          >
            ...
            <div className="mt-14 flex justify-center">
              <Link to="/community" className="relative group block transition-transform duration-300 hover:scale-105 active:scale-105">
                {/* Main Button */}
                <div className="relative border-2 border-[#00ff7f] rounded-xl bg-transparent px-10 py-4 text-[#00ff7f] font-bold text-lg sm:text-xl transition-all duration-300 group-hover:bg-[#00ff7f]/5 group-active:bg-[#00ff7f]/5 active:bg-[#00ff7f]/5 group-hover:shadow-[0_0_15px_rgba(0,255,127,0.2)] group-active:shadow-[0_0_15px_rgba(0,255,127,0.2)] active:shadow-[0_0_15px_rgba(0,255,127,0.2)]">
                  Join the Community
                </div>
                {/* Overlapping Pill */}
                <div className="absolute -top-5 left-1/2 -translate-x-1/2 w-7 h-10 rounded-full border-2 border-[#00ff7f] bg-[#010a05] flex items-center justify-center transition-all duration-300 group-hover:shadow-[0_0_10px_rgba(0,255,127,0.2)] group-active:shadow-[0_0_10px_rgba(0,255,127,0.2)] active:shadow-[0_0_10px_rgba(0,255,127,0.2)]">
              ...
              <div className="grid grid-cols-2 gap-y-10 md:grid-cols-4 md:gap-y-0 relative">
                {STATS.map((s, i) => (
                  <div key={s.label} className="relative text-center group">
                    <div className="text-4xl sm:text-5xl font-extrabold tracking-tight text-white transition-all duration-300 group-hover:scale-110 group-active:scale-110 active:scale-110 group-hover:text-transparent group-active:text-transparent active:text-transparent group-hover:bg-clip-text group-active:bg-clip-text active:bg-clip-text group-hover:bg-gradient-to-r group-active:bg-gradient-to-r active:bg-gradient-to-r group-hover:from-[#32CD32] group-active:from-[#32CD32] active:from-[#32CD32] group-hover:via-[#e2da24] group-active:via-[#e2da24] active:via-[#e2da24] group-hover:to-[#32CD32] group-active:to-[#32CD32] active:to-[#32CD32]">
                      <Counter to={s.value} suffix={s.suffix} />
                    </div>
                    <div className="mt-3 text-xs sm:text-sm font-bold uppercase tracking-[0.15em] text-[#00ff7f]/70 group-hover:text-[#32CD32] group-active:text-[#32CD32] active:text-[#32CD32] transition-colors">
                      {s.label}
                    </div>
      ...
      <section className="relative z-10 container-page py-24">
        <div className="grid gap-12 lg:grid-cols-2 lg:items-center">
          <Reveal>
            ...
            <div className="mt-8 grid gap-4 sm:grid-cols-2">
              {[
                ...
                <div key={f.title} className="group rounded-xl border border-[#00ff7f]/20 bg-white/5 p-4 backdrop-blur-md transition-all duration-300 hover:border-[#00ff7f] active:border-[#00ff7f] hover:bg-white/10 active:bg-white/10 hover:shadow-[0_0_12px_rgba(0,255,127,0.4)] active:shadow-[0_0_12px_rgba(0,255,127,0.4)]">
                  <div className="grid h-9 w-9 place-items-center rounded-lg bg-[#00ff7f]/10 text-[#00ff7f] transition-transform duration-300 group-hover:bg-[#00ff7f]/20 group-active:bg-[#00ff7f]/20 active:bg-[#00ff7f]/20 group-hover:scale-110 group-active:scale-110 active:scale-110">
                    <f.icon className="h-4 w-4" />
                  </div>
                  <div className="mt-3 font-semibold text-white transition-all duration-300 group-hover:text-transparent group-active:text-transparent active:text-transparent group-hover:bg-clip-text group-active:bg-clip-text active:bg-clip-text group-hover:bg-gradient-to-r group-active:bg-gradient-to-r active:bg-gradient-to-r group-hover:from-[#32CD32] group-active:from-[#32CD32] active:from-[#32CD32] group-hover:via-[#e2da24] group-active:via-[#e2da24] active:via-[#e2da24] group-hover:to-[#32CD32] group-active:to-[#32CD32] active:to-[#32CD32]">{f.title}</div>
                  <p className="mt-1 text-sm text-white/60">{f.body}</p>
                </div>
              ))}
            </div>
            <Button asChild variant="ghost" className="mt-8 -ml-3 text-brand hover:text-brand active:text-brand hover:bg-brand/5 active:bg-brand/5">
              <Link to="/about">
          ...
          <Reveal delay={0.15}>
            <div className="relative aspect-[4/5] overflow-hidden rounded-3xl border border-[#00ff7f]/30 bg-gradient-to-br from-[#00ff7f]/10 via-transparent to-transparent group transition-all duration-300 hover:border-[#00ff7f] active:border-[#00ff7f] hover:shadow-[0_0_12px_rgba(0,255,127,0.4)] active:shadow-[0_0_12px_rgba(0,255,127,0.4)]">
              <img
                ...
                className="h-full w-full object-cover transition-transform duration-500 group-hover:scale-105 group-active:scale-105 active:scale-105"
                loading="lazy"
              />
      ...
      <section className="relative z-10 container-page py-24">
        ...
        <div className="mt-16 flex flex-col gap-10 max-w-5xl mx-auto">
          {/* Card 1 */}
          <Reveal delay={0.1}>
            <article className="flex flex-col md:flex-row items-center gap-8 md:gap-12 rounded-[2rem] border border-hairline bg-surface-elevated p-6 md:p-8 transition-all duration-500 hover:border-brand/40 active:border-brand/40 hover:shadow-[0_0_40px_rgba(0,255,127,0.1)] active:shadow-[0_0_40px_rgba(0,255,127,0.1)] group">
              {/* Image side */}
              <div className="w-full md:w-1/3 shrink-0">
                <div className="relative aspect-[4/5] max-w-[300px] mx-auto md:max-w-none rounded-[1.5rem] overflow-hidden bg-black/40 border border-hairline flex items-center justify-center transition-transform duration-500 group-hover:scale-[1.02] group-active:scale-[1.02] active:scale-[1.02]">
                  <User className="w-32 h-32 text-brand/20 transition-transform duration-500 group-hover:scale-110 group-active:scale-110 active:scale-110" />
              ...
              <div className="w-full md:w-2/3 flex flex-col justify-center">
                ...
                <div className="mt-8 pt-6 border-t border-hairline">
                  <a
                    ...
                    className="inline-flex items-center justify-center w-10 h-10 rounded-full bg-white transition-transform hover:scale-110 active:scale-110 shadow-[0_0_15px_rgba(255,255,255,0.2)]"
                  >
          ...
          {/* Card 2 */}
          <Reveal delay={0.2}>
            <article className="flex flex-col md:flex-row-reverse items-center gap-8 md:gap-12 rounded-[2rem] border border-hairline bg-surface-elevated p-6 md:p-8 transition-all duration-500 hover:border-brand/40 active:border-brand/40 hover:shadow-[0_0_40px_rgba(0,255,127,0.1)] active:shadow-[0_0_40px_rgba(0,255,127,0.1)] group">
              {/* Image side */}
              <div className="w-full md:w-1/3 shrink-0">
                <div className="relative aspect-[4/5] max-w-[300px] mx-auto md:max-w-none rounded-[1.5rem] overflow-hidden bg-black/40 border border-hairline flex items-center justify-center transition-transform duration-500 group-hover:scale-[1.02] group-active:scale-[1.02] active:scale-[1.02]">
                  <User className="w-32 h-32 text-brand/20 transition-transform duration-500 group-hover:scale-110 group-active:scale-110 active:scale-110" />
            ...
            <div className="grid gap-6 md:grid-cols-2">
              {EVENTS.filter((e) => e.status === "upcoming").slice(0, 1).map((e, i) => (
                <Reveal key={e.id} delay={0.1}>
                  <div className="flex flex-col h-full rounded-3xl border border-[#00ff7f]/30 bg-white/5 overflow-hidden backdrop-blur-md transition-all duration-300 hover:border-[#00ff7f] active:border-[#00ff7f] hover:shadow-[0_0_12px_rgba(0,255,127,0.4)] active:shadow-[0_0_12px_rgba(0,255,127,0.4)] relative group">
              ...
              {EVENTS.filter((e) => e.status === "ongoing").slice(0, 1).map((e, i) => (
                <Reveal key={e.id} delay={0.2}>
                  <div className="flex flex-col h-full rounded-3xl border border-[#3b82f6]/40 bg-white/5 overflow-hidden backdrop-blur-md transition-all duration-300 hover:border-[#3b82f6] active:border-[#3b82f6] hover:shadow-[0_0_12px_rgba(59,130,246,0.4)] active:shadow-[0_0_12px_rgba(59,130,246,0.4)] relative group">
                  ...
                  {EVENTS.filter((e) => e.status === "past").map((e, i) => (
                    <Reveal key={e.id} delay={i * 0.1}>
                      <div className="relative pl-8 sm:pl-12 group">
                        <div className="absolute left-[-17px] top-4 flex h-8 w-8 items-center justify-center rounded-full bg-[#020b06] border-2 border-white/20 transition-all group-hover:border-[#00ff7f] group-active:border-[#00ff7f] active:border-[#00ff7f] group-hover:shadow-[0_0_15px_rgba(0,255,127,0.4)] group-active:shadow-[0_0_15px_rgba(0,255,127,0.4)] active:shadow-[0_0_15px_rgba(0,255,127,0.4)]">
                        <EventIcon category={e.category} />
                      </div>
                      <div onClick={undefined} className="block overflow-hidden rounded-2xl border border-white/10 bg-white/5 backdrop-blur-md transition-all duration-300 hover:-translate-y-1 active:-translate-y-1 hover:border-white/50 active:border-white/50 hover:shadow-[0_0_12px_rgba(255,255,255,0.2)] active:shadow-[0_0_12px_rgba(255,255,255,0.2)] sm:flex cursor-pointer">
                        ...
                        <div className="p-5 sm:w-2/3 flex flex-col justify-center">
                          ...
                          <h4 className="mt-3 text-lg font-bold transition-all duration-300 group-hover:text-transparent group-active:text-transparent active:text-transparent group-hover:bg-clip-text group-active:bg-clip-text active:bg-clip-text group-hover:bg-gradient-to-r group-active:bg-gradient-to-r active:bg-gradient-to-r group-hover:from-[#32CD32] group-active:from-[#32CD32] active:from-[#32CD32] group-hover:via-[#e2da24] group-active:via-[#e2da24] active:via-[#e2da24] group-hover:to-[#32CD32] group-active:to-[#32CD32] active:to-[#32CD32]">{e.title}</h4>
                          <p className="mt-2 text-sm text-muted-foreground line-clamp-2 sm:line-clamp-none">{e.description}</p>
                          <Link to="/events" className="mt-4 inline-flex items-center gap-1.5 text-xs font-bold uppercase tracking-wider text-white/50 transition-colors group-hover:text-[#00ff7f] group-active:text-[#00ff7f] active:text-[#00ff7f]">
                            Learn more <ArrowRight className="h-3.5 w-3.5 transition-transform group-hover:translate-x-1 group-active:translate-x-1 active:translate-x-1" />
                          </Link>
                        </div>
                      </div>
                    </div>
        ...
        <div className="mt-10 grid gap-6 sm:grid-cols-2 lg:grid-cols-3 max-w-5xl mx-auto">
          {TEAM.slice(0, 9).map((m, i) => (
            <Reveal key={m.name} delay={i * 0.05}>
              <div className="group relative overflow-hidden rounded-2xl border border-[#00ff7f]/20 bg-white/5 backdrop-blur-md transition-all duration-300 hover:border-[#00ff7f] active:border-[#00ff7f] hover:shadow-[0_0_12px_rgba(0,255,127,0.4)] active:shadow-[0_0_12px_rgba(0,255,127,0.4)]">
                    ...
                    <div className="absolute top-4 right-4 flex gap-2 z-10">
                      {(m as any).github && (
                        <a
                          ...
                          target="_blank"
                          rel="noreferrer"
                          className="grid h-10 w-10 place-items-center rounded-full bg-white text-[#333] shadow-lg transition-transform duration-300 hover:scale-110 active:scale-110"
                      ...
                      <a
                        ...
                        target="_blank"
                        rel="noreferrer"
                        className="grid h-10 w-10 place-items-center rounded-full bg-white text-[#0A66C2] shadow-lg transition-transform duration-300 hover:scale-110 active:scale-110"
                ...
                <div className="p-4">
                  ...
                  <div className="mt-1 font-semibold transition-all duration-300 group-hover:text-transparent group-active:text-transparent active:text-transparent group-hover:bg-clip-text group-active:bg-clip-text active:bg-clip-text group-hover:bg-gradient-to-r group-active:bg-gradient-to-r active:bg-gradient-to-r group-hover:from-[#32CD32] group-active:from-[#32CD32] active:from-[#32CD32] group-hover:via-[#e2da24] group-active:via-[#e2da24] active:via-[#e2da24] group-hover:to-[#32CD32] group-active:to-[#32CD32] active:to-[#32CD32]">{m.name}</div>
                </div>
              </div>
            </Reveal>
          ))}
      ...
      <section className="relative z-10 overflow-hidden py-24">
        ...
        <div className="container-page flex flex-col items-center">
                ...
                {[...RECRUITERS.slice(0, 14), ...RECRUITERS.slice(0, 14)].map((r, i) => (
                  <div key={i} className="flex items-center justify-center min-w-[200px] group relative">
                    <img 
                      ...
                      alt={r.name} 
                      className="h-14 w-14 rounded-md object-contain transition-transform duration-300 group-hover:scale-110 group-active:scale-110 active:scale-110 drop-shadow-[0_0_15px_rgba(255,255,255,0.05)]" 
                      onError={(e) => {
          ...
          <div className="mt-20 text-center">
            <Button asChild className="group relative rounded-full border border-[#00ff7f]/50 bg-[#00ff7f]/5 px-8 py-6 text-[#00ff7f] font-bold text-lg backdrop-blur-md transition-all hover:bg-[#00ff7f]/10 active:bg-[#00ff7f]/10 hover:shadow-[0_0_25px_rgba(0,255,127,0.25)] active:shadow-[0_0_25px_rgba(0,255,127,0.25)]">
              <Link to="/alumni" className="flex items-center gap-2">
                Meet our alumni 
                <ArrowUpRight className="h-5 w-5 transition-transform group-hover:translate-x-1 group-active:translate-x-1 active:translate-x-1 group-hover:-translate-y-1 group-active:-translate-y-1 active:-translate-y-1" />
              </Link>
            </Button>
          </div>
        </div>
        ...
        >
          ...
          >
            {[...TESTIMONIALS, ...TESTIMONIALS].map((t, i) => (
              <figure key={i} className="relative w-[300px] sm:w-[380px] shrink-0 overflow-hidden rounded-2xl border border-white/10 bg-[#060D09] p-6 sm:p-8 transition-all duration-500 hover:-translate-y-2 active:-translate-y-2 hover:border-[#00ff7f] active:border-[#00ff7f] hover:shadow-[0_0_12px_rgba(0,255,127,0.4)] active:shadow-[0_0_12px_rgba(0,255,127,0.4)] group cursor-default whitespace-normal flex flex-col justify-between">
                <div className="absolute -right-4 -top-8 text-[140px] font-serif leading-none text-[#00ff7f]/5 group-hover:text-[#00ff7f]/10 group-active:text-[#00ff7f]/10 active:text-[#00ff7f]/10 transition-colors pointer-events-none select-none">"</div>
                <div className="absolute top-0 left-0 w-full h-[2px] bg-gradient-to-r from-transparent via-[#00ff7f]/50 to-transparent opacity-0 group-hover:opacity-100 group-active:opacity-100 active:opacity-100 transition-opacity duration-500" />
                
                <blockquote className="relative z-10 text-sm sm:text-base leading-relaxed text-white/90 font-medium">
                  "{t.quote}"
                </blockquote>
                
                <figcaption className="relative z-10 mt-8 flex items-center gap-4 border-t border-white/10 pt-5 group-hover:border-[#00ff7f]/30 group-active:border-[#00ff7f]/30 active:border-[#00ff7f]/30 transition-colors">
                  <div className="relative grid h-12 w-12 shrink-0 place-items-center rounded-xl bg-gradient-to-br from-[#00ff7f]/20 to-[#00ff7f]/5 border border-[#00ff7f]/30 text-[#00ff7f] font-bold text-xl overflow-hidden group-hover:scale-110 group-active:scale-110 active:scale-110 transition-transform duration-500">
                    <div className="absolute inset-0 bg-[#00ff7f] opacity-0 group-hover:opacity-20 group-active:opacity-20 active:opacity-20 animate-pulse" />
                    {t.name.charAt(0)}
                  </div>
                  <div className="overflow-hidden">
                    <div className="text-sm sm:text-base font-bold text-white tracking-wide truncate group-hover:text-[#00ff7f] group-active:text-[#00ff7f] active:text-[#00ff7f] transition-colors">{t.name}</div>
      ...
      <section className="relative z-10 container-page pb-24">
        <div className="group relative overflow-hidden rounded-[2rem] border border-white/5 bg-[#060D09] p-8 md:p-10 transition-all duration-300 hover:border-[#00ff7f] active:border-[#00ff7f] hover:shadow-[0_0_12px_rgba(0,255,127,0.4)] active:shadow-[0_0_12px_rgba(0,255,127,0.4)]">
          ...
          <div className="relative grid gap-8 lg:grid-cols-2 lg:items-center">
            ...
            <div className="flex lg:justify-end w-full">
              <form onSubmit={(e) => e.preventDefault()} className="flex w-full max-w-lg flex-col sm:flex-row gap-3">
                ...
                <Button 
                  type="submit" 
                  className="h-14 px-8 rounded-xl bg-[#00ff7f] text-[#020b06] hover:bg-[#00ff7f]/90 active:bg-[#00ff7f]/90 font-bold text-base transition-all shrink-0"
                >
    ...
    >
      <div className="relative aspect-[16/9] overflow-hidden">
        <img
          src={event.image}
          alt={event.title}
          className="h-full w-full object-cover transition-transform duration-700 group-hover:scale-105 group-active:scale-105 active:scale-105"
          loading="lazy"
        />
        <div className="absolute inset-0 bg-gradient-to-t from-background/80 via-transparent to-transparent opacity-0 transition-opacity duration-300 group-hover:opacity-100 group-active:opacity-100 active:opacity-100" />
      ...
      <div className="flex flex-col flex-1 p-6 md:p-8">
        ...
        <h3 className="mt-2 text-2xl font-bold tracking-tight text-white group-hover:text-transparent group-active:text-transparent active:text-transparent group-hover:bg-clip-text group-active:bg-clip-text active:bg-clip-text group-hover:bg-gradient-to-r group-active:bg-gradient-to-r active:bg-gradient-to-r group-hover:from-[#32CD32] group-active:from-[#32CD32] active:from-[#32CD32] group-hover:via-[#e2da24] group-active:via-[#e2da24] active:via-[#e2da24] group-hover:to-[#32CD32] group-active:to-[#32CD32] active:to-[#32CD32] transition-all">{event.title}</h3>
        <p className="mt-3 text-base text-white/60 flex-1">{event.description}</p>
        <Link 
          to="/events/$eventId"
          params={{ eventId: event.id }}
          className="mt-6 inline-flex items-center gap-1.5 text-sm font-semibold text-white/80 transition-colors hover:text-white active:text-white" 
          style={{ color: event.status === 'ongoing' ? 'rgba(59,130,246,0.8)' : 'rgba(0,255,127,0.8)' }}
        >
          Learn more <ArrowUpRight className="h-4 w-4 transition-transform group-hover:translate-x-1 group-active:translate-x-1 active:translate-x-1 group-hover:-translate-y-1 group-active:-translate-y-1 active:-translate-y-1" />
        </Link>
      </div>
    </div>
  );
