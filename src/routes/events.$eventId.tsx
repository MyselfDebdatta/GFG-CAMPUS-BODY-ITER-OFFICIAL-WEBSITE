...
const EVENT_COPY: Record<string, { brief: string; objectives: string[]; timeline: { label: string; desc: string }[] }> = {
  ...
  "rachitva-event": {
    brief: "Rachitva inspired participants to transform abstract ideas into compelling product concepts through creativity and innovation. Teams demonstrated exceptional design thinking, branding, and persuasive pitching under tight time constraints, building valuable experience in product development and strategic marketing.",
    objectives: [
      "Transforming abstract concepts into polished product designs and brand assets",
      "Applying rapid design thinking and strategic marketing principles",
      "Delivering persuasive live product pitches under tight time constraints",
      "Developing entrepreneurial spirit and effective team communication",
    ],
    timeline: [
      { label: "Design Brief Unveiling", desc: "Product challenge revealed with design thinking guidelines" },
      { label: "Branding & Pitch Sprint", desc: "Teams craft wireframes, product slides, and marketing strategies" },
      { label: "Live Pitch Arena", desc: "Compelling product presentations to a panel of expert judges" },
      { label: "Judge Q&A & Awards", desc: "Evaluation on design feasibility, presentation, and final awards" },
    ],
  },
  "zerone-event": {
    brief: "Zer0ne: Capture the Flag successfully blended technology, strategy, and innovation through an engaging multidisciplinary challenge. Teams showcased technical expertise and collaborative problem-solving while adapting to a dynamic virtual economy, concluding with impactful solution presentations.",
    objectives: [
      "Hackathon-style development and multidisciplinary CTF problem solving",
      "Real-time decision making, resource management, and strategic teamwork",
      "Adapting to dynamic virtual economy constraints and live evaluations",
      "Impactful solution presentations evaluated by expert judges and mentors",
    ],
    timeline: [
      { label: "CTF Challenge Drop", desc: "Multidisciplinary challenge and virtual economy rules revealed" },
      { label: "Strategy & Build Sprint", desc: "Teams collaborate on resource allocation and technical execution" },
      { label: "Solution Evaluation", desc: "Final solution presentations, code demos, and live testing" },
      { label: "Winners & Closing", desc: "Felicitation and closing remarks on technical excellence" },
    ],
  },
  "raw-and-ready": {
