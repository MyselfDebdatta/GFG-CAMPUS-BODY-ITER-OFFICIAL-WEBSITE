  ...
  return (
    ...
    >
      <Link
        ...
        className="group relative inline-flex max-w-[calc(100vw-2rem)] sm:max-w-none items-center gap-2 sm:gap-3 rounded-full border border-[#00ff7f]/40 bg-[#060D09]/95 px-3 py-1.5 sm:px-5 sm:py-2 text-xs sm:text-sm font-medium text-white/90 backdrop-blur-xl transition-all duration-300 hover:border-[#00ff7f] hover:bg-[#00ff7f]/10 hover:shadow-[0_0_25px_rgba(0,255,127,0.3)] active:scale-98 cursor-pointer shadow-[0_4px_20px_rgba(0,0,0,0.5)]"
      >
        ...
        <span className="text-white/90 group-hover:text-white font-medium truncate text-[11px] sm:text-sm text-left">
          <span className="sm:hidden">Recruitment 2026–27 Live Now!</span>
          <span className="hidden sm:inline">Registration for GFG Members Recruitment (2026–2027 Session) is Live Now!</span>
        </span>
        <span className="inline-flex items-center gap-0.5 sm:gap-1 rounded-full bg-[#00ff7f] px-2 py-0.5 sm:px-2.5 sm:py-0.5 text-[9px] sm:text-[11px] font-bold text-[#020b06] transition-all group-hover:bg-white shrink-0 ml-auto sm:ml-1">
          <span>Apply</span>
